...
class MylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mylist" do
    assert_difference('Mylist.count') do
      post mylists_url, params: { mylist: { author_id: @mylist.author_id, comic_id: @mylist.comic_id, user_id: @mylist.user_id } }
    end
  ...
  test "should update mylist" do
    patch mylist_url(@mylist), params: { mylist: { author_id: @mylist.author_id, comic_id: @mylist.comic_id, user_id: @mylist.user_id } }
