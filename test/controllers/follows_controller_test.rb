...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { followed_id: @follow.followed_id, user_id: @follow.user_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { followed_id: @follow.followed_id, user_id: @follow.user_id } }
