...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { author_id: @comic.author_id, genre_id: @comic.genre_id, labels_id: @comic.labels_id, publisher_id: @comic.publisher_id, title: @comic.title } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { author_id: @comic.author_id, genre_id: @comic.genre_id, labels_id: @comic.labels_id, publisher_id: @comic.publisher_id, title: @comic.title } }
