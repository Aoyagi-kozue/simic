...
class RecommendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommend" do
    assert_difference('Recommend.count') do
      post recommends_url, params: { recommend: { comic_id: @recommend.comic_id, user_id: @recommend.user_id } }
    end
  ...
  test "should update recommend" do
    patch recommend_url(@recommend), params: { recommend: { comic_id: @recommend.comic_id, user_id: @recommend.user_id } }
